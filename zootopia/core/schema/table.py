...
class Tables(Enum):
    ...
    AGENTS__subscribe_message = "subscribe_message"
    ...
    ROOMS__subscribe_message_sent = "subscribe_message_sent"
...
class AgentTableModel(BaseModel):
    ...
    subscribe_message: Optional[str] = Field(default=None)
...
class RoomTableModel(BaseModel):
    ...
    subscribe_message_sent: bool = Field(default=False)
...
class SubscriptionTableModel(BaseModel):
    ...
    room_id: int
    created_at: datetime = Field(default_factory=utc_now)
    ended_at: str = Field(default=None)
