...
class Tables(Enum):
    ...
    TASKS = "tasks"
    TASKS__id = "id"
    TASKS__created_at = "created_at"
    TASKS__room_id = "room_id"
    TASKS__type = "type"  # respond, remind, revive
    TASKS__run_at = "run_at"
    TASKS__context = "context"
    TASKS__complete = "complete"
...
class TaskTableModel(BaseModel):
    id: Optional[int] = Field(default=None, description="Auto-generated by database")
    created_at: datetime = Field(default_factory=utc_now)
    room_id: int = Field(default=None)
    name: Optional[str] = Field(default=None)
    type: str = Field(default="respond")
    # run_at: datetime = Field(default=utc_now)
